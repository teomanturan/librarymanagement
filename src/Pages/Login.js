...
function Login() {
  ...
  return (
    <div style={{ backgroundColor: "transparent" }} className="page-md login">
      {/* BEGIN LOGO */}
      <div className="logo">
        <a href="index.html">
        ...
        >
          ...
          <div className="form-actions" style={{ margin: "0" }}>
            ...
            <button type="submit" className="btn blue pull-right">
              Login <i className="m-icon-swapright m-icon-white" />
            </button>
          </div>
        </form>
        {/* END LOGIN FORM */}
        ...
        <form className="forget-form" action="index.html" method="post">
          ...
          <div className="form-actions">
            <button type="button" id="back-btn" className="btn">
              <i className="m-icon-swapleft" /> Back{" "}
            </button>
            <button type="submit" className="btn blue pull-right">
              Submit <i className="m-icon-swapright m-icon-white" />
            </button>
          </div>
        </form>
        ...
        <form className="register-form" action="index.html" method="post">
          ...
          <div className="form-group">
            <label>
              ...
              and <a href="javascript:;">Privacy Policy </a>
            </label>
            <div id="register_tnc_error"></div>
          </div>
          <div className="form-actions">
            <button id="register-back-btn" type="button" className="btn">
              <i className="m-icon-swapleft" /> Back{" "}
            </button>
            <button
              type="submit"
            ...
            >
              Sign Up <i className="m-icon-swapright m-icon-white" />
            </button>
          </div>
        </form>
